...
- **Failed combinations** consume resources but become marked as invalid, preventing brute-force retries.
...
- Players learn **intuitive rules** rather than memorizing static formulas.
  - For example, “Ign” relates to heat, “Tel” implies direction or projection, etc.
...
- Texts often contain **partial clues or metaphoric hints** about rune combinations.
  - Example: “The flame’s whisper pierces truth when guided straight.”

- Some writings are **damaged or incomplete**, forcing creative inference or experimentation.
- All texts are written in **stylized English**, maintaining accessibility and immersion.
- This encourages **pattern recognition and logical deduction** over repetition.
...
- **Implementation:**
  - 3–4 predefined rule sets modify core rune relationships.
  - A random set is selected during world generation.
  - Some players may encounter similar patterns in later playthroughs.

- **Effect:**
  - Encourages **relearning, adaptability, and fresh experimentation** each run.
  - Adds meaningful replayability without overwhelming new players.
...
- Skilled players may **enhance their casting through gestures or mouse movements**.
  - Proper gestures can:
    ...
    - Increase damage or effect potency.
    - Unlock **alternate spell forms** (e.g., dragging straight during a cast turns a Magic Dart into a Piercing Shot).
- Gestures represent **precision and control** — not more power, but refined channeling.
- Some grimoires include **gesture diagrams or hidden instructions**, rewarding curious players.
- Failed or imprecise gestures may cause **unstable effects** such as wasted mana or minor backlash.
- This layer remains **optional**, serving as an expression of mastery for players who wish to deepen their craft.
...
- Inspired by *Mage Arena*’s “spoken spell” design, adapted into a tactile input system.
...
- **Runic Patterns:**
  - Manually trace shapes of runes to activate spells.
  
- **Sequence Input:**
  - Quick key or button sequences replicate the rune order for rapid casting.
...
- Complements the wand system, creating a **dual mastery loop**:
  - Crafting defines creation.
  - Casting defines execution.